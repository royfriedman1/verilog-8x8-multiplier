# 8x8 Sequential Multiplier – Detailed Description
...
## 🖥️ Simulation
The project includes a testbench (`mult8x8_tb.v`) to verify functionality.  
Example results:  
...
Waveform screenshots are provided in the `images/` folder.  
Full simulation logs can be found in the `docs/` folder.
